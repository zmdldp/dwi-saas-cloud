package com.dwi.saas.oauth.config.mq;
...
public class TenantDatasourceConfiguration {
	...
	public Binding dsQueueBinding() {
		return new Binding(BizMqQueue.TENANT_DS_QUEUE_BY_OAUTH, Binding.DestinationType.QUEUE,
				BizMqQueue.TENANT_DS_FANOUT_EXCHANGE_OAUTH, "", new HashMap(1));
	}
