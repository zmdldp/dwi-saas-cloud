package com.dwi.saas.example.config.datasource;
...
public class ExampleMybatisAutoConfiguration extends BaseMybatisConfiguration {


    public ExampleMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
    ...
    protected List<InnerInterceptor> getPaginationBeforeInnerInterceptor() {
        ...
        if (isDataScope) {
            list.add(new DataScopeInnerInterceptor(userId -> SpringUtils.getBean(UserBizApi.class).getDataScopeById(userId)));
        }
        return list;
    }
