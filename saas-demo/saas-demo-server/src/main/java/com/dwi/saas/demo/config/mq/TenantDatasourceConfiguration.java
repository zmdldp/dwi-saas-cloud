package com.dwi.saas.demo.config.mq;
...
public class TenantDatasourceConfiguration {
	...
	public Binding dsQueueBinding() {
		return new Binding(BizMqQueue.TENANT_DS_QUEUE_BY_DEMO, Binding.DestinationType.QUEUE,
				BizMqQueue.TENANT_DS_FANOUT_EXCHANGE_DEMO, "", new HashMap(1));
	}
