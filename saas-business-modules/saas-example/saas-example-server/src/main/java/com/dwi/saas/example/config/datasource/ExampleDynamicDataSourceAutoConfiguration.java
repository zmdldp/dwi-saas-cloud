...
public class ExampleDynamicDataSourceAutoConfiguration extends BaseDynamicDataSourceAutoConfiguration {

    public ExampleDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
