...
(
    `id`          bigint(20) NOT NULL COMMENT 'ID',
    `name`        varchar(255) NOT NULL DEFAULT '' COMMENT '名称',
    `org_id`      bigint(20) DEFAULT NULL COMMENT '组织ID \n#c_org\n@Echo(api = ORG_ID_CLASS, method = FIND_BY_IDS, beanClass = Org.class) RemoteData<Long, com.dwi.saas.authority.domain.entity.core.Org>',
    `state`       bit(1)                DEFAULT b'1' COMMENT '状态',
    `describe_`   varchar(255)          DEFAULT '' COMMENT '描述',
    `create_time` datetime              DEFAULT NULL COMMENT '创建时间',
    `created_by`  bigint(20) DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE IF NOT EXISTS `undo_log`
    ...
    `xid`           VARCHAR(100) NOT NULL COMMENT 'global transaction id',3
