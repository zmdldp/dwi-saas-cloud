...
import com.dwi.saas.authority.hystrix.UserApiFallback;
 ...
 * @date 2020/07/02
 */
@FeignClient(name = "${saas.feign.authority-server:saas-authority-server}", fallback = UserApiFallback.class
