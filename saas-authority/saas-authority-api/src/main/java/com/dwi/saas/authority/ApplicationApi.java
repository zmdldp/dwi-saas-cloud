...
import com.dwi.saas.authority.hystrix.ApplicationApiFallback;
 ...
 * @date 2020/12/16
 */
@FeignClient(name = "${saas.feign.authority-server:saas-authority-server}", fallback = ApplicationApiFallback.class
