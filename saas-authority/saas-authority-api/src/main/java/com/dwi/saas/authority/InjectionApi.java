...
import com.dwi.saas.authority.hystrix.InjectionApiFallback;
 ...
 * @date 2021/01/20
 */
@FeignClient(name = "${saas.feign.authority-server:saas-authority-server}", fallback = InjectionApiFallback.class, qualifier = "authorityInjectionApi")
