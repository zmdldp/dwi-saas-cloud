package com.dwi.saas.msg.config.mq;
...
//import com.dwi.saas.tenant.DatasourceApi;
...
public class TenantDatasourceConfiguration {
	...
	public Queue dsQueue() {
		return new Queue(BizMqQueue.TENANT_DS_QUEUE_BY_MSG);
	}

	@Bean
	@ConditionalOnProperty(prefix = DatabaseProperties.PREFIX, name = "multiTenantType", havingValue = "DATASOURCE")
	public Binding dsQueueBinding() {
		return new Binding(BizMqQueue.TENANT_DS_QUEUE_BY_MSG, Binding.DestinationType.QUEUE,
				BizMqQueue.TENANT_DS_FANOUT_EXCHANGE_MSG, "", new HashMap(1));
	}

	@RabbitListener(queues = BizMqQueue.TENANT_DS_QUEUE_BY_MSG)
	@ConditionalOnProperty(prefix = DatabaseProperties.PREFIX, name = "multiTenantType", havingValue = "DATASOURCE")
