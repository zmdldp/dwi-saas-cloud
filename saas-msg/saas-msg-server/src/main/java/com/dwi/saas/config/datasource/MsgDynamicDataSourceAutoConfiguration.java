package com.dwi.saas.config.datasource;
...
public class MsgDynamicDataSourceAutoConfiguration extends BaseDynamicDataSourceAutoConfiguration {

    public MsgDynamicDataSourceAutoConfiguration(DynamicDataSourceProperties properties) {
        super(properties);
    }
