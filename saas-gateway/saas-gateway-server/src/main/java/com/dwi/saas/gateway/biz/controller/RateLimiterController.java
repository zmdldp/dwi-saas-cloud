package com.dwi.saas.gateway.biz.controller;

import com.dwi.basic.base.controller.SuperController;
import com.dwi.saas.gateway.biz.entity.RateLimiter;
 ...
 * 1，saas-ui/src/api/BlockList.js 所有的url增加 /gate 的前缀。 如： /gate/gateway/blocklist/page
 * 2，saas-ui/src/api/RateLimiter.js 所有的url增加 /gate 的前缀。 如： /gate/gateway/rateLimiter/page
 *
 * @author dwi
