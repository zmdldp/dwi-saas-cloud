package com.dwi.saas.gateway.biz.config.mq;
...
public class TenantDatasourceConfiguration {
	...
	public Binding dsQueueBinding() {
		return new Binding(BizMqQueue.TENANT_DS_QUEUE_BY_GATEWAY, Binding.DestinationType.QUEUE,
				BizMqQueue.TENANT_DS_FANOUT_EXCHANGE_GATEWAY, "", new HashMap(1));
	}
