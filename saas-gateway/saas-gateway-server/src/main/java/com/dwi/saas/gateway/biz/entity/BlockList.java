package com.dwi.saas.gateway.biz.entity;
...
public class BlockList extends Entity<Long> {
    ...
    @Size(max = 20, message = "阻止列表IP不能超过20")
    ...
    @Size(max = 255, message = "请求URI不能超过255")
    ...
    @Size(max = 10, message = "请求方法不能超过10")
